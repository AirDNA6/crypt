...
import HallTwoMovieThumb from './HallTwoMovieThumb'
import HallTwoColGrid from './HallTwoColGrid'
...
class HallTwo extends Component {
  state = {
    movies: [],
    heroImage: null,
    loading: false,
  ...
  render() {
    ...
    <Navbar.Brand style={{ backgroundColor: "#21d192", color: "#343A40"}}>HALL 2</Navbar.Brand>
  </Navbar>
